...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "/images/blogs/arunachal-pradesh/dirang/dirang-view.webp", width: 1200, height: 919, alt: "Dirang, Arunachal Pradesh" }],
  },
  twitter: { card: "summary_large_image", title: "Dirang Travel Guide: Hot Springs, Apple Orchards & Dirang Dzong", description: "Hot springs, apple orchards, and a fortified monastery on the road to Tawang — the complete guide to Dirang.", images: ["/images/blogs/arunachal-pradesh/dirang/dirang-view.webp"] },
...
function ArticleSchema() {
  return (
    <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
      ...
      image: "https://club.kudozz.in/images/blogs/arunachal-pradesh/dirang/dirang-view.webp",
      ...
      <main>
        <section className="relative min-h-[75vh] flex flex-col justify-end overflow-hidden">
          <div className="absolute inset-0">
            <Image
              src="/images/blogs/arunachal-pradesh/dirang/dirang-view.webp"
              alt="Dirang, Arunachal Pradesh" fill priority sizes="100vw" className="object-cover" />
