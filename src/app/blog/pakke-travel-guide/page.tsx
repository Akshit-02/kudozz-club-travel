...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "/images/blogs/arunachal-pradesh/pakke/pakke-tiger-reserve.webp", width: 1600, height: 1200, alt: "Pakke Tiger Reserve, Arunachal Pradesh" }],
  },
  twitter: { card: "summary_large_image", title: "Pakke Tiger Reserve Travel Guide: Hornbills & Foothill Forest", description: "A community-led hornbill conservation model in Arunachal's foothill forest — the complete guide to Pakke.", images: ["/images/blogs/arunachal-pradesh/pakke/pakke-tiger-reserve.webp"] },
...
function ArticleSchema() {
  return (
    <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
      ...
      image: "https://club.kudozz.in/images/blogs/arunachal-pradesh/pakke/pakke-tiger-reserve.webp",
      ...
      <main>
        <section className="relative min-h-[75vh] flex flex-col justify-end overflow-hidden">
          <div className="absolute inset-0">
            <Image src="/images/blogs/arunachal-pradesh/pakke/pakke-tiger-reserve.webp" alt="Pakke Tiger Reserve, Arunachal Pradesh" fill priority sizes="100vw" className="object-cover" />
