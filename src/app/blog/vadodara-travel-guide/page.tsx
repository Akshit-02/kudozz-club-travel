...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "/images/blogs/gujarat/vadodara/laxmi-vilas-palace-vadodara.webp", width: 1600, height: 1063, alt: "Laxmi Vilas Palace, Vadodara" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "Vadodara Travel Guide: Laxmi Vilas Palace & Baroda's Heritage",
    description: "The Gaekwad royal family's palace and Baroda's layered heritage — the complete guide to Vadodara.",
    images: ["/images/blogs/gujarat/vadodara/laxmi-vilas-palace-vadodara.webp"],
  },
    ...
    <script
      ...
      dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          image: "https://club.kudozz.in/images/blogs/gujarat/vadodara/laxmi-vilas-palace-vadodara.webp",
      ...
      <main>
        <section className="relative min-h-[75vh] flex flex-col justify-end overflow-hidden">
          <div className="absolute inset-0">
            <Image src="/images/blogs/gujarat/vadodara/laxmi-vilas-palace-vadodara.webp" alt="Laxmi Vilas Palace, Vadodara" fill priority sizes="100vw" className="object-cover" />
              ...
              <div className="prose-travel">
                ...
                <section id="top-attractions">
                  ...
                  <div className="relative w-full rounded-xl my-6 h-72 overflow-hidden shadow-md">
                    <Image src="/images/blogs/gujarat/vadodara/champaner-pavagadh-archaeological-park-vadodara.webp" alt="Champaner-Pavagadh Archaeological Park, Vadodara" fill sizes="(min-width: 1280px) 768px, (min-width: 1024px) 640px, 100vw" className="object-cover" />
                  </div>
                  <ul>
