...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "/images/blogs/chhattisgarh/bhoramdeo/bhoramdeo-temple.webp", width: 1600, height: 1200, alt: "Bhoramdeo Temple, Chhattisgarh" }],
  },
  twitter: { card: "summary_large_image", title: "Bhoramdeo Temple Travel Guide: Chhattisgarh's Khajuraho", description: "An 11th-century carved temple complex — the complete guide to Bhoramdeo.", images: ["/images/blogs/chhattisgarh/bhoramdeo/bhoramdeo-temple.webp"] },
...
function ArticleSchema() {
  return (
    <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
      ...
      image: "https://club.kudozz.in/images/blogs/chhattisgarh/bhoramdeo/bhoramdeo-temple.webp",
      ...
      <main>
        <section className="relative min-h-[75vh] flex flex-col justify-end overflow-hidden">
          <div className="absolute inset-0">
            <Image src="/images/blogs/chhattisgarh/bhoramdeo/bhoramdeo-temple.webp" alt="Bhoramdeo Temple, Chhattisgarh" fill priority sizes="100vw" className="object-cover" />
            ...
            <article className="flex-1 min-w-0 max-w-2xl xl:max-w-none">
              <div className="prose-travel">
                ...
                <section id="top-attractions">
                  ...
                  <GuideFigure src="/images/blogs/chhattisgarh/bhoramdeo/bhoramdeo-temple-view.webp" alt="Bhoramdeo Temple, Chhattisgarh" />
                  <ul>
