...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "/images/blogs/karnataka/dandeli/dandeli.webp", width: 1600, height: 1200, alt: "View of Dandeli, Karnataka" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "Dandeli Travel Guide: White-Water Rafting & Wildlife Sanctuary",
    description: "Karnataka's best-known adventure sports hub — the complete guide to Dandeli.",
    images: ["/images/blogs/karnataka/dandeli/dandeli.webp"],
  },
    ...
    <script
      ...
      dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          image: "https://club.kudozz.in/images/blogs/karnataka/dandeli/dandeli.webp",
      ...
      <main>
        <section className="relative min-h-[75vh] flex flex-col justify-end overflow-hidden">
          <div className="absolute inset-0">
            <Image src="/images/blogs/karnataka/dandeli/dandeli.webp" alt="View of Dandeli, Karnataka" fill priority sizes="100vw" className="object-cover" />
