...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/images/blogs/madhya-pradesh/kanha/kanha-national-park.webp",
        width: 1600,
        height: 1067,
        alt: "Kanha National Park, Madhya Pradesh",
      },
    ],
  },
  twitter: {
    ...
    images: ["/images/blogs/madhya-pradesh/kanha/kanha-national-park.webp"],
  },
  alternates: {
    ...
    <script
      ...
      dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          image: "https://club.kudozz.in/images/blogs/madhya-pradesh/kanha/kanha-national-park.webp",
      ...
      <main>
        <section className="relative min-h-[75vh] flex flex-col justify-end overflow-hidden">
          <div className="absolute inset-0">
            <Image
              src="/images/blogs/madhya-pradesh/kanha/kanha-national-park.webp"
              alt="Kanha National Park, Madhya Pradesh"
              fill
              priority
              sizes="100vw"
            ...
            <article className="flex-1 min-w-0 max-w-2xl xl:max-w-none">
              <div className="prose-travel">
                ...
                <section id="best-time">
                  ...
                  <GuideFigure src="/images/blogs/madhya-pradesh/kanha/kanha-national-park-view.webp" alt="Kanha National Park, Madhya Pradesh" />
                  <p>
