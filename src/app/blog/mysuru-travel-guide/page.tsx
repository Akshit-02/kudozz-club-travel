...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "/images/blogs/karnataka/mysuru/mysore-palace-mysuru.webp", width: 1600, height: 900, alt: "Mysore Palace, Mysuru" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "Mysuru Travel Guide: Mysore Palace, Dasara & City Guide",
    description: "A Wodeyar-dynasty palace and a ten-day Dasara procession — the complete guide to Mysuru.",
    images: ["/images/blogs/karnataka/mysuru/mysore-palace-mysuru.webp"],
  },
    ...
    <script
      ...
      dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          image: "https://club.kudozz.in/images/blogs/karnataka/mysuru/mysore-palace-mysuru.webp",
      ...
      <main>
        <section className="relative min-h-[75vh] flex flex-col justify-end overflow-hidden">
          <div className="absolute inset-0">
            <Image src="/images/blogs/karnataka/mysuru/mysore-palace-mysuru.webp" alt="Mysore Palace, Mysuru" fill priority sizes="100vw" className="object-cover" />
              ...
              <div className="prose-travel">
                ...
                <section id="top-attractions">
                  ...
                  <div className="relative w-full rounded-xl my-6 h-72 overflow-hidden shadow-md">
                    <Image src="/images/blogs/karnataka/mysuru/devaraja-market-mysuru.webp" alt="Devaraja Market, Mysuru" fill sizes="(min-width: 1280px) 768px, (min-width: 1024px) 640px, 100vw" className="object-cover" />
                  </div>
                  <ul>
