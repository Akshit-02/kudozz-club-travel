...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "/images/blogs/arunachal-pradesh/tawang/tawang.webp", width: 1500, height: 1000, alt: "View of Tawang, Arunachal Pradesh" }],
  },
  twitter: { card: "summary_large_image", title: "Tawang Travel Guide: Monastery, War Memorial & Best Time to Visit", description: "India's largest Buddhist monastery and dramatic Eastern Himalayan scenery — the complete guide to Tawang.", images: ["/images/blogs/arunachal-pradesh/tawang/tawang.webp"] },
...
function ArticleSchema() {
  return (
    <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
      ...
      image: "https://club.kudozz.in/images/blogs/arunachal-pradesh/tawang/tawang.webp",
      ...
      <main>
        <section className="relative min-h-[75vh] flex flex-col justify-end overflow-hidden">
          <div className="absolute inset-0">
            <Image src="/images/blogs/arunachal-pradesh/tawang/tawang.webp" alt="View of Tawang, Arunachal Pradesh" fill priority sizes="100vw" className="object-cover" />
              ...
              <div className="prose-travel">
                ...
                <section id="top-attractions">
                  ...
                  <div className="relative w-full rounded-xl my-6 h-72 overflow-hidden shadow-md">
                    <Image src="/images/blogs/arunachal-pradesh/tawang/nuranang-falls-tawang.webp" alt="Nuranang Falls, Tawang" fill sizes="(min-width: 1280px) 768px, (min-width: 1024px) 640px, 100vw" className="object-cover" />
                  </div>
                  <ul>
                  ...
                  <GuidePhotoRow
                    images={[
                      { src: "/images/blogs/arunachal-pradesh/tawang/tawang-monastery.webp", alt: "Tawang Monastery, Arunachal Pradesh", caption: "Tawang Monastery, Arunachal Pradesh" },
                      { src: "/images/blogs/arunachal-pradesh/tawang/tawang-war-memorial.webp", alt: "Tawang War Memorial, Arunachal Pradesh", caption: "Tawang War Memorial, Arunachal Pradesh" },
                      { src: "/images/blogs/arunachal-pradesh/tawang/bum-la-pass-tawang.webp", alt: "Bum La Pass, Tawang", caption: "Bum La Pass, Tawang" },
                    ]}
                  />
                </section>
