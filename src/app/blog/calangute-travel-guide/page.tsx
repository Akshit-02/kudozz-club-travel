...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "/images/blogs/goa/calangute/calangute-beach.webp", width: 1600, height: 1200, alt: "Calangute Beach, Goa" }],
  },
  twitter: { card: "summary_large_image", title: "Calangute Beach Travel Guide: Goa's Busiest Beach & Nightlife", description: "Goa's original, busiest beach resort town — the complete guide to Calangute.", images: ["/images/blogs/goa/calangute/calangute-beach.webp"] },
...
function ArticleSchema() {
  return (
    <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
      ...
      image: "https://club.kudozz.in/images/blogs/goa/calangute/calangute-beach.webp",
      ...
      <main>
        <section className="relative min-h-[75vh] flex flex-col justify-end overflow-hidden">
          <div className="absolute inset-0">
            <Image src="/images/blogs/goa/calangute/calangute-beach.webp" alt="Calangute Beach, Goa" fill priority sizes="100vw" className="object-cover" />
