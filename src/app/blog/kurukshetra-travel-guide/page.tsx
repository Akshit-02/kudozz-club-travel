...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "/images/blogs/haryana/kurukshetra/brahma-sarovar-kurukshetra.webp", width: 1600, height: 1200, alt: "Brahma Sarovar, Kurukshetra" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "Kurukshetra Travel Guide: Bhagavad Gita's Battlefield & Brahma Sarovar",
    description: "Jyotisar, Brahma Sarovar, and the legendary Mahabharata battlefield — the complete guide to Kurukshetra.",
    images: ["/images/blogs/haryana/kurukshetra/brahma-sarovar-kurukshetra.webp"],
  },
    ...
    <script
      ...
      dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          image: "https://club.kudozz.in/images/blogs/haryana/kurukshetra/brahma-sarovar-kurukshetra.webp",
      ...
      <main>
        <section className="relative min-h-[75vh] flex flex-col justify-end overflow-hidden">
          <div className="absolute inset-0">
            <Image
              src="/images/blogs/haryana/kurukshetra/brahma-sarovar-kurukshetra.webp"
